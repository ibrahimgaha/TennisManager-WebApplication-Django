...
from reservations.views import (
    ...
    update_coach_reservation, update_reservation, update_terrain
)
from core.views import RegisterView, footer, home, nav, reservation  # Import reservation here
...
urlpatterns = [
    ...
    path('create-or-update-schedule/', create_or_update_schedule, name='create_or_update_schedule'),
    ...
    path('', home, name='home'),
    path('reservation/', reservation, name='reservation'),  # Corrected path
